...
newtype SpanOfTime a = SpanOfTime
  { startTime :: a
  , stopTime   :: a
  }
...
instance encodeJsonSpanOfTime :: EncodeJson a => EncodeJson (SpanOfTime a) where
  encodeJson (SpanOfTime {startTime,stopTime}) =
    "startTime" := startTime ~> "stopTime" := stopTime ~> jsonEmptyObject
